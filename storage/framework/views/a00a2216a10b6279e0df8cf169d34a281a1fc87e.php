            ...
            <div class="section-body">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Employee')): ?>
                    <div class=" text-right">
                        <a href="<?php echo e(route('employee.edit',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>" class="btn btn-icon icon-left btn-primary mb-10 ">
                        ...
                        <div class="employee-detail-wrap">
                            <div class="card">
                                <div class="card-header">
                                    <h4><?php echo e(__('Personal Detail')); ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="employee-detail-wrap">
                            <div class="card">
                                <div class="card-header"><h4><?php echo e(__('Document Detail')); ?></h4></div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwy3ovb7nhy6/public_html/hrms.82solutions.com/resources/views/employee/show.blade.php ENDPATH**/ ?>