                                    ...
                                    <table class="table table-striped mb-0" id="dataTable">
                                        ...
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="<?php echo e(route('setsalary.show',$employee->id)); ?>" class="btn btn-outline-warning btn-sm mr-1">
                                                        <i class="fas fa-eye"> <span><?php echo e(__('View')); ?></span></i>
                                                    </a>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Set Salary')): ?>
                                                        <a href="<?php echo e(URL::to('setsalary/'.$employee->id.'/edit')); ?>" class="btn btn-outline-primary btn-sm mr-1">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Set Salary')): ?>
                                                        ...
                                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['setsalary.destroy', $employee->id],'id'=>'delete-form-'.$employee->id]); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwy3ovb7nhy6/public_html/hrms.82solutions.com/resources/views/setsalary/index.blade.php ENDPATH**/ ?>